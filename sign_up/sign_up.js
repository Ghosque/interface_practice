...
function checkOne() {
    ...
    if (ACCOUNT_VALUE == ''){
        document.getElementById("account-img").src = "ban.jpg";
        document.getElementById("account-title").textContent = "请输入账号";
    }
    else {
        document.getElementById("account-img").src = "success.jpg";
...
function checkTwo(){
    ...
    if (PASSWORD_VALUE == ''){
        document.getElementById("password-img").src = "ban.jpg";
        document.getElementById("password-title").textContent = "请输入密码";
    }
    else {
        document.getElementById("password-img").src = "success.jpg";
...
function checkThree() {
    ...
    if (CONFIRM_VALUE == ''){
        document.getElementById("confirm-img").src = "ban.jpg";
...
function checkFour(){
    ...
    if (VERIFY_VALUE == ""){
        document.getElementById("verify-img").src = "ban.jpg";
        document.getElementById("verify-title").textContent = "请输入验证码";
    }
    else {
        document.getElementById("verify-img").src = "success.jpg";
